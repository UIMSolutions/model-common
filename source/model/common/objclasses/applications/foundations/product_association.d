module model.common.objclasses.applications.foundations.product_association;

import model.common;

static this() {
  // Information about a product property.
  gsCommon.objclasses("common/foundation/productAssociation", new class DEIMObjclass {
    this() {
      super(); 
      this.attributes([
        ...
        "versionNumber":"common/foundation/productAssociation/versionNumber", // Version Number
