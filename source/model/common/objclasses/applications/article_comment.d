...
static this() {
  ...
  gsCommon.objclasses("common/application/articleComment", new class DEIMObjclass {
    this() {
      super(); 
      this.attributes([
        "createdOn":"common/createdOn", //	Date and time when the knowledge base article comment was created.	
        "createdBy":"common/createdBy", //	Unique identifier of the user who created the knowledge base article comment.	
        "modifiedOn":"common/modifiedOn", //	Date and time when the knowledge base article comment was last modified.	
        "modifiedBy":"common/modifiedBy", //	Unique identifier of the user who last modified the knowledge base article comment.	
