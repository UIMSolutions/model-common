module models.common.objclasses.applications.foundations.crm.projects.services.project_parameter_pricelist;

import models.common;

static this() {
  // List of settings that determine the behavior of the project-based service solution.
  gsCommon.objclasses("common/crm/project/service/projectParameterPriceList", new class DOOPObjclass {
    this() {
      super();
