module models.common.objclasses.applications.foundations.crm.projects.services.project_parameter;

import models.common;

static this() {
  // List of settings that determine the behavior of the project-based service solution.
  gsCommon.objclasses("common/crm/project/service/projectParameter", new class DOOPObjclass {
    this() {
      super();
