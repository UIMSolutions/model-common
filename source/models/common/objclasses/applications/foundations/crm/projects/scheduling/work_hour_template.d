module models.common.objclasses.applications.foundations.crm.projects.scheduling.work_hour_template;

import models.common;

static this() {
  // Template where resource working hours can be saved and reused.
  gsCommon.objclasses("common/application/foundation/crm/project/scheduling/workHourTemplate", new class DOOPObjclass {
    this() {
      super();
