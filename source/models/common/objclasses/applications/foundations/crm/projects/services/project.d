module models.common.objclasses.applications.foundations.crm.projects.services.project;

import models.common;

static this() {
  // Delivery entity in an engagement.
  gsCommon.objclasses("common/crm/project/service/project", new class DOOPObjclass {
    this() {
      super();
...
unittest {
  // assert(gsCommon.objclasses("common/crm/project/service/project").name == "common/crm/project/service/project");
}