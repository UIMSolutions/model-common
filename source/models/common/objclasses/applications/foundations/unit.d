module models.common.objclasses.applications.foundations.unit;

import models.common;

static this() {
  // Unit of measure.
  gsCommon.objclasses("common/foundation/unit", new class DOOPObjclass {
    this() {
      super();
      this.objclass("common/entity").attclasses([
        ...
        "organizationId":"dataformat/guid/nullable/false", // Unique identifier of the organization associated with the unit of measure.
