module models.common.objclasses.applications.foundations.bookable_resource_booking_header;

import models.common;

static this() {
  // Reservation entity representing the summary of the associated resource bookings.
  gsCommon.objclasses(new class DOOPObjclass {
    this() {
      super(); 
      this
      .name("common/foundation/bookableResourceBookingHeader")
      .objclass("common/entity")
      .attclasses([
